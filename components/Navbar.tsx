...
const Navbar: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      {/* Mobile Menu */}
      <div
        className={`md:hidden backdrop-blur-md border-b border-blue-900/30 flex flex-col items-center gap-5 text-gray-300 font-medium overflow-hidden transition-all duration-500 ease-in-out ${
          menuOpen ? "max-h-[400px] opacity-100 translate-y-0 py-4" : "max-h-0 opacity-0 -translate-y-5"
        }`}
      >
        ...
        <button
          ...
          className="bg-blue-600 text-white font-semibold px-6 py-2 rounded-full mb-2 hover:bg-blue-700 transition cursor-pointer"
        >
          Get Started
        </button>
      </div>
