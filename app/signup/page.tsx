    ...
    return (
      <div className="min-h-screen bg-[#0A0A0F] flex items-center justify-center px-4">
        <div className="text-center">
          ...
          <a href="/login" className="inline-flex items-center gap-2 mt-8 text-blue-400 hover:text-blue-300 text-sm font-medium transition-colors">
                ...
                <div className="rounded-2xl overflow-hidden" style={{ background: "linear-gradient(135deg, rgba(37,99,235,0.3), rgba(139,92,246,0.3))", border: "1px solid rgba(96,165,250,0.2)" }}>
                  <div className="p-4">
                    <div className="flex items-start justify-between mb-3">
                      <div>
                        <div className="text-xs text-blue-300 font-semibold mb-1 uppercase tracking-wider">Featured Course</div>
