    ...
    <div className="min-h-screen bg-slate-50">
      <div className="max-w-xl mx-auto px-4 sm:px-6 py-6 sm:py-10 space-y-4">
        ...
        <div className="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden">
          ...
          {/* Blue banner */}
          <div className="relative h-24 sm:h-28 bg-gradient-to-r from-blue-600 via-blue-500 to-blue-400 overflow-hidden">
            <div
            ...
            <div className="flex items-end gap-4 -mt-10 sm:-mt-11 mb-5">
              ...
              <div className="relative flex-shrink-0 group cursor-pointer">
                {showPhoto ? (
                  ...
                  <>
                    <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-2xl sm:rounded-3xl bg-gradient-to-br from-blue-500 to-blue-700 border-4 border-white shadow-xl flex items-center justify-center select-none">
              ...
              <div className="min-w-0 pb-1">
                <p className="text-base sm:text-lg font-bold text-slate-900 truncate leading-tight">
                  {name || "—"}
                </p>
              ...
              {editingName ? (
                <div className="space-y-3">
                  <input
                    ...
                    className="w-full text-sm font-medium text-slate-900 bg-slate-50 border border-slate-300 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent focus:bg-white transition-all placeholder:text-slate-400"
                  />
                  <div className="flex gap-2.5">
                    <button
                      onClick={handleSaveName}
                      disabled={saveState === "saving" || !nameInput.trim()}
                      className="flex-1 sm:flex-none flex items-center justify-center gap-2 px-5 py-2.5 bg-slate-900 hover:bg-slate-700 disabled:bg-slate-300 disabled:cursor-not-allowed text-white text-sm font-semibold rounded-xl transition-colors active:scale-[0.98]"
                    >
                      {saveState === "saving" ? (
                        <>
                          <SpinnerIcon />
                    ...
                    <button
                      ...
                      className="flex-1 sm:flex-none px-5 py-2.5 text-sm font-semibold text-slate-600 hover:text-slate-900 bg-slate-100 hover:bg-slate-200 rounded-xl transition-colors active:scale-[0.98]"
                    >
                      Cancel
                    </button>
                  </div>
        ...
        <div className="bg-white rounded-3xl border border-slate-200 shadow-sm">
          <div className="px-5 sm:px-7 py-5">
            <div className="flex items-center justify-between gap-4">
              ...
              <span className="flex-shrink-0 text-[10px] font-bold bg-emerald-50 text-emerald-600 border border-emerald-200 px-2.5 py-1 rounded-full tracking-wide">
                Verified
              </span>
            </div>
          </div>
        ...
        <div className="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden divide-y divide-slate-100">
          ...
          <button className="w-full flex items-center gap-4 px-5 sm:px-7 py-4 sm:py-5 text-left hover:bg-red-50/60 active:bg-red-50 transition-colors group">
           ...
           {/*  <div className="flex-1 min-w-0">
            ...
            <ChevronIcon className="w-4 h-4 text-slate-300 group-hover:text-red-300 group-hover:translate-x-0.5 transition-all flex-shrink-0" />
          </button>
        </div>
...
const SpinnerIcon = ({ className }: { className?: string }) => (
  <span
    className={`w-4 h-4 border-2 border-current border-t-transparent rounded-full animate-spin inline-block opacity-70 ${className ?? ""}`}
  />
);
